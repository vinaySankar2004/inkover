...
## Decision
Snapping is triggered by holding the Pencil still for 500 ms before lifting. The highlighter uses it for straight lines. Any future snap uses the same gesture.
