...
| Manifest | `extension/manifest.json` | Manifest v3. Permissions: storage, activeTab, host `<all_urls>`. The background script is declared non-persistent; App Store Connect rejects an iOS upload without it. |
